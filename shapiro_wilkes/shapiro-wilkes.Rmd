...
FalseNegative <- function(N){
  ...
  ggplot(df, aes(s)) +
    ...
    geom_label(aes(x = mu, label = paste0(mu, " %"), y = 0.18)) +
    xlim(0,100) +
    ylim(0,.2) +
    labs(x = "percent",
...
pdf("/Users/ethan/Documents/GitHub/stat-simulations/shapiro_wilkes/Shapiro_Wilkes Simulation.pdf")
plot(p_grid)
dev.off()
